...
// Copy html files from /templates into /dist
...
// Copy html files from /templates into /dist, Function for Gulp Watch
...
gulp.task("vendor:build", function() {
  var jsStream = gulp
    .src([
      ...
      "./assets/js/vendor/datetimepicker.js",
      "./assets/js/vendor/rSlider.min.js",
      "./assets/js/vendor/print.min.js",
...
gulp.task("watch", function browserDev(done) {
  ...
  // Copy html files from /templates into /dist and refresh on the change 
  ...
  gulp.watch(
    [
      ...
      "./templates/content/partials/*.html", 
    ]
    ).on("change", series(htmlTemplate));
  gulp.watch(
    [
      "./templates/*.html",
      "./templates/partials/*.html",
...
// Default task
gulp.task("default", gulp.series("clean", "build", "replaceHtmlBlock", "include"));
